...
<head>
    ...
    <link href="resume_page/HTML/styles.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="resume_page/HTML/css/prettyPhoto.css" type="text/css" media="screen" charset="utf-8" />
    ...
    <script type="text/javascript" src="resume_page/HTML/js/jquery.prettyPhoto.js"></script>
    <script type="text/javascript" src="resume_page/HTML/js/jquery.easing.1.3.js"></script>

</head>

<body>
<div id="header">
    <div id="logo"><a href="#"><img src="jpg/chalk1.jpg" alt="Hand written mathematics on my personal chalk wall!"></a></div>
    <ul id="main-menu">
...
<div id="container">
    ...
    <div id="about">
        ...
        <div class="content">
            <img src="resume_page/HTML/images/designer-photo.jpg" />
